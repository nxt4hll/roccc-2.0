...
public class ImportModuleWizardPage extends WizardPage 
{
	public Text sourceFileField;
	public Text moduleName;
	public Combo project;
	
	public ImportModuleWizardPage(String pageName) 
	{
		super(pageName);
		setTitle("Import ROCCC Module");
		setDescription("Choose a ROCCC Module file and a project to import it into.\n");
	}
	...
	public void createControl(Composite parent) 
	{
		...
		group1.setText("Import ROCCC Module");
			...
			public void widgetSelected(SelectionEvent e)
			{
				try
				{
					...
					if(sourceFileField.getText().equals(oldFile) == false)
					{
						...
						try
						{
							if(moduleName != null && moduleName.getText().equals("") == true)
								moduleName.setText(f.getName().split("\\.")[0]);
						}
						catch(Exception ex){}
					}
				}
		...
		moduleName = new Text(sourceSection, SWT.BORDER);
