...
import rocccplugin.wizards.ImportModuleWizard;

public class ImportModuleHandler implements IHandler 
{
	...
	public Object execute(ExecutionEvent event) throws ExecutionException 
	{
		...
		EclipseResourceUtils.openWizard(new ImportModuleWizard());
