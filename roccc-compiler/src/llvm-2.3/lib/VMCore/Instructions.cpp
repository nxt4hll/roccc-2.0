...
// ROCCC Functions added here
/*
CopyInstruction::CopyInstruction(const Type* Ty, Value* V, 
				 Instruction* insertBefore) :
  UnaryInstruction(Ty, 45, V, insertBefore)
{
  ;
}

CopyInstruction* CopyInstruction::clone() const
{
  return NULL ;
}
*/
