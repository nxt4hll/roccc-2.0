...
class PredIterator : public forward_iterator<_Ptr, std::ptrdiff_t> {
  typedef forward_iterator<_Ptr, std::ptrdiff_t> super;
  _USE_iterator It;
public:
...
class SuccIterator : public bidirectional_iterator<BB_, std::ptrdiff_t> {
  const Term_ Term;
  unsigned idx;
  typedef bidirectional_iterator<BB_, std::ptrdiff_t> super;
public:
