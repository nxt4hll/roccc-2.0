...
private :
  ...
  // ROCCC Change
  //  In order to support DFBasicBlocks we have to make the constructor
  //  protected.  This allows us to inherit off of this class while
  //  still mainly preserving the ability to prevent anyone from
  //  creating a BasicBlock without calling "Create"
...
public:
  ...
  // Added ROCCC functions 
  //  These are needed due to errors in shared library implementations
  //  on some systems.
  virtual bool isDFBasicBlock() { return false ; }
  virtual DFBasicBlock* getDFBasicBlock() { return NULL ; }
