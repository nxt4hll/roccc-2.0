...
private:
  ...
  // ROCCC Change
  //  Protected so I can derive a class off of it
...
public:
  ...
  // ROCCC Added functions
  //  These are here due to errors in shared libraries not working correctly
  //  with dynamic_cast on some implementations
  virtual bool isDFFunction() { return false ; }
  virtual DFFunction* getDFFunction() { return NULL ; }
