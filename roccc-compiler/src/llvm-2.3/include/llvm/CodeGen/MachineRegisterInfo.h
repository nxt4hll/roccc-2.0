...
public:
  ...
  class defusechain_iterator
    : public forward_iterator<MachineInstr, std::ptrdiff_t> {
    MachineOperand *Op;
  ...
  public:
    typedef forward_iterator<MachineInstr, std::ptrdiff_t>::reference reference;
    typedef forward_iterator<MachineInstr, std::ptrdiff_t>::pointer pointer;
