...
public:
  ...
  class use_iterator
    : public forward_iterator<SDUse, std::ptrdiff_t> {
    SDUse *Op;
    explicit use_iterator(SDUse *op) : Op(op) {
    }
    friend class SDNode;
  public:
    typedef forward_iterator<SDUse, std::ptrdiff_t>::reference reference;
    typedef forward_iterator<SDUse, std::ptrdiff_t>::pointer pointer;
...
public:
  ...
  class SDNodeIterator : public forward_iterator<SDNode, std::ptrdiff_t> {
  SDNode *Node;
  unsigned Operand;
