...
#pragma interface "print_cfg/suif_pass.h"
#endif
...
class PrintCfgSuifPass : public PipelinablePass {  protected:
    PrintCfg print_cfg;		// the OPI-pass object
    ...
    std::set<IdString> out_procs;
  public:
    PrintCfgSuifPass(SuifEnv* suif_env, const IdString &name = "print_cfg");
    ~PrintCfgSuifPass(void);
...
extern "C" void init_print_cfg(SuifEnv *suif_env);
