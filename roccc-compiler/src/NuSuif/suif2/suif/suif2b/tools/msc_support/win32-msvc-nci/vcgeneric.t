...
#${
	...
	Project('TMAKE_LIBS *= imm32.lib wsock32.lib');
	if ( Config("opengl") ) {
    ...
    if ( Project("PRE_LINK") && Config("dll") ) {
	Project('MSVCDSP_PRE_LINK =
## Begin Special Build Tool
WkspDir=.
TargetName=$$MSVCDSP_TARGET
SOURCE="$(InputPath)"
PreLink_Desc=---------------------- Running pre-link tool ----------------------
PreLink_Cmds=$$PRE_LINK
