...
DFA_StateTableExpansionPass ;
LookupTableExpansionPass ; 
...
load $1.suif ;
require bit_vector_dataflow_analysis global_transforms array_transforms optimizer_output;
require loop_transforms;
ControlFlowSolvePass ;
DataFlowSolvePass ;
UD_DU_ChainBuilderPass ;
ConstantPropagationAndFoldingPass;
...
save $1.suif ; """ ,  
"""\
require basicnodes suifnodes cfenodes transforms control_flow_analysis utility_transforms optimizer_output ;
load $1.suif
require data_dependence_analysis ;
LoopInfoPass ;
PreprocessingPass ;
BufferTypeDetectionPass ;
# BitResizeDatapathConstantsPass ;
